    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="text-center">
          ...
          <div className="font-mono text-[11px] uppercase tracking-wider text-frost/60">
            {game.month}
          </div>
        </div>
        ...
        <div className="flex flex-1 items-center justify-center gap-4 px-4">
          ...
          <span className="font-mono text-xs text-frost/55">vs</span>
      ...
      <div className="mt-5 flex items-center justify-between border-t border-white/10 pt-4">
        <div>
          ...
          <div className="mt-0.5 font-mono text-[11px] text-frost/60">{game.venue}</div>
        </div>
        <span className="inline-flex items-center gap-1 font-mono text-[11px] text-frost/55 transition-colors group-hover:text-ice-blue">
          Match centre
